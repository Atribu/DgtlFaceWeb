        ...
        <div className="w-[1200px] h-[350px] rounded-[22px] bg-[#140F25] my-12">
            ...
            >
                ...
                <div className="text-white text-center pt-20">
                    <h1 class="text-[#FFF] text-justify font-inter text-[32px] font-bold leading-[120%] ml-16 tracking-[-0.64px]">
                    Our Original <span className="bg-gradient-to-r from-[#54B9CF] via-[#547CCF] to-[#A754CF] bg-clip-text text-transparent">Story</span>
                    </h1>
                    <p className="w-[365px] text-[#FFF] text-start font-inter text-[14px] font-normal leading-[140%] tracking-[-0.28px] ml-16 mt-2">DGTLFACE, a digital marketing agency established in 2019, provides online marketing services to a wide range of companies, from local brands and startups to large corporations. Our company is headquartered in Antalya, and with our creative and collaborative professional team, we operate not only in Turkey but also in many countries across Europe.</p>
                    <button className="-mt-16 inline-flex px-[32px] py-[16px] justify-center items-center gap-[10px] rounded-[22px] bg-[#FFF] shadow-[0px_0px_50px_0px_rgba(221,254,254,0.5),0px_0px_4px_0px_#FFF]"><p className="text-black font-inter text-[18px] font-bold leading-[120%] tracking-[-0.36px] leading-trim">Get in Touch</p></button>
                </div>
            </div>
        </div>
        <div className='flex flex-row items-center justify-center'>
            <div className="inline-flex text-start flex-col items-center gap-[75px]">
            <div className="w-[440px] h-[777.31px] flex flex-col gap-5">
                ...
                <div className="text-main-dark-blue font-inter text-[16px] font-normal leading-[140%] tracking-[-0.32px]">
                    ...
                    master the digital space by strategically using our products and services to attract the attention of a large online audience.
                </div>
