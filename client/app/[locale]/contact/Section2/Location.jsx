...
const Location = () => {
  return (
    <div className='flex flex-col gap-5 items-center justify-center mt-10 lg:mt-24 w-full bg-white mb-[50px] lg:mb-[100px]'>
      ...
      <div className="relative text-center justify-start text-[#140f25] text-base font-normal font-inter leading-snugv mt-[16px]">Yenigün, Hacıoğulları Apt, Kızılırmak Cd. No: 18 B, 07310 Muratpaşa/Antalya</div>
