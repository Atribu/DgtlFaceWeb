...
function buildSoftwareKvkkComplianceServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "KVKK Uyum Hizmeti",
          serviceType: "KVKK Uyum Hizmeti / Data Compliance",
          country: "Türkiye",
        }
      : {
          home: "Home",
          ...
          current: "KVKK Compliance Service",
          serviceType: "KVKK Compliance Service / Data Compliance",
          country: "Turkey",
        };
...
const jsonLd = buildSoftwareKvkkComplianceServiceJsonLd({
  locale,
  baseUrl,
  ...
  return (
    <>
<JsonLd id="software-kvkk-compliance-service-jsonld" data={jsonLd} />
      ...
      <div className="flex flex-col gap-[80px] lg:gap-[100px] bg-[#080612] overflow-hidden items-center justify-center">
        ...
        <QuestionsSection2 variant="light" faqs={faqs} />
          <FaqPrompt
                                         namespace="KVKK.faqPrompt"
                                        faqSlug="kvkk-uyum-hizmeti-sss"
                                       />
