...
export async function generateMetadata({ params }) {
  ...
  const title =
    seoData?.title ||
    "Reklam Performans Raporlama – Veri Odaklı SEM Analizi | DGTLFACE";
...
function buildAdReportingServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "Reklam Raporlama & Performans",
          serviceType: "Reklam Raporlama & Performans Analizi",
        }
      : {
          home: "Home",
          services: "Services",
          parent: "SEM – Digital Advertising Management",
          current: "Ad Reporting & Performance",
          serviceType: "Ad Reporting & Performance Analysis",
        };
...
const Page = async ({ params }) => {
  ...
  const t2 = await getTranslations({
    locale,
    namespace: "PerformanceAnalysis.h4Section",
  });
  ...
  const jsonLd = buildAdReportingServiceJsonLd({
    locale,
    baseUrl,
  ...
  return (
    <>
      <JsonLd id="ad-reporting-service-jsonld" data={jsonLd} />
      ...
      <div className="flex flex-col gap-[80px] lg:gap-[100px] bg-[#080612] overflow-hidden items-center justify-center">
        ...
        <FaqPrompt
          ...
          faqSlug="sem/reklam-raporlama-sss"
        />
