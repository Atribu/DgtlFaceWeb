...
function buildYoutubeAdsServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  parentUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          home: "Ana Sayfa",
          parent: "SEM",
          current: "YouTube Reklam Yönetimi",
          serviceType: "YouTube Reklam Yönetimi",
          country: "Türkiye",
        }
      : {
          home: "Home",
          parent: "SEM",
          current: "YouTube Advertising Management",
          serviceType: "YouTube Advertising Management",
          country: "Turkey",
        };
...
const Page = async ({ params }) => {
  ...
  const t = await getTranslations({
    locale,
    namespace: "YoutubeAdvertising",
  });

  const t2 = await getTranslations({
    locale,
    namespace: "YoutubeAdvertising.h4Section",
  });
  ...
  const jsonLd = buildYoutubeAdsServiceJsonLd({
    locale,
    baseUrl,
  ...
  return (
    <>
      <JsonLd id="youtube-ads-service-jsonld" data={jsonLd} />
      ...
      <div className="flex flex-col gap-[80px] lg:gap-[100px] bg-[#080612] overflow-hidden items-center justify-center">
        ...
        <FaqPrompt
          ...
          faqSlug="sem/youtube-reklam-yonetimi-sss"
        />
