...
export async function generateMetadata({ params }) {
  ...
  const title =
    seoData?.title ||
    "Backlink Yönetimi – Dijital Otorite ve Güven Sinyali Artırma | DGTLFACE";

  const description =
    seoData?.description ||
    "DGTLFACE, güçlü backlink stratejileriyle sitenizin otoritesini artırır. Güvenilir ve etkili bağlantılarla Google sıralamalarınızı yükseltin.";
...
function buildBacklinkSeoServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "Backlink & Dijital Otorite Yönetimi",
          serviceType: "Backlink & Dijital Otorite Yönetimi",
          country: "Türkiye",
          area: "Antalya",
        }
      : {
          ...
          current: "Backlink & Digital Authority Management",
          serviceType: "Backlink & Digital Authority Management",
          country: "Turkey",
          area: "Antalya",
        };
...
const Page = async ({ params }) => {
  ...
  const t = await getTranslations({
    locale,
    namespace: "BacklinkSeo",
  });

  const t2 = await getTranslations({
    locale,
    namespace: "BacklinkSeo.h4Section",
  });

  const jsonLd = buildBacklinkSeoServiceJsonLd({
    locale,
    baseUrl,
  ...
  return (
    <>
      <JsonLd id="backlink-seo-service-jsonld" data={jsonLd} />
      ...
      <div className="flex flex-col gap-[80px] lg:gap-[100px] bg-[#080612] overflow-hidden items-center justify-center">
        ...
        <FaqPrompt
          namespace="BacklinkSeo.faqPrompt"
          faqSlug={
            locale === "tr"
              ? "seo/backlink-yonetimi-sss"
              : "search-engine-optimization/backlink-management-faq"
          }
        />
