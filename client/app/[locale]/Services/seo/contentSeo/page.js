...
function buildContentSeoServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "İçerik SEO",
          serviceType: "İçerik SEO (Content SEO)",
          country: "Türkiye",
          area: "Antalya",
        }
      : {
...
const Page = async ({ params }) => {
  ...
  // Eğer getCanonicalUrl("/Services/seo", locale) eski /tr/seo-hizmetleri dönüyorsa bu explicit mapping korunmalı.
  const parentSeoUrl =
    locale === "tr"
      ? `${baseUrl}/tr/seo`
  ...
  const t = await getTranslations({
    locale,
    namespace: "ContentSeo",
  });

  const t2 = await getTranslations({
    locale,
    namespace: "ContentSeo.h4Section",
  });

  const jsonLd = buildContentSeoServiceJsonLd({
    locale,
    baseUrl,
    ...
    serviceDescription: stripHtml(t("content_ai_answer_text")),
  });
  ...
  return (
    <>
      <JsonLd id="content-seo-service-jsonld" data={jsonLd} />
      ...
      <div className="flex flex-col gap-[80px] lg:gap-[100px] bg-[#080612] overflow-hidden items-center justify-center">
        ...
        <FaqPrompt
          ...
          faqSlug={
            locale === "tr"
              ? "seo/icerik-seo-sss"
              : "search-engine-optimization/content-seo-faq"
          }
        />
