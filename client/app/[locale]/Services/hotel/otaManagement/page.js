...
function buildHotelOtaManagementServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "OTA & Kanal Yönetimi",
          serviceType: "Otel OTA Yönetimi / Hotel OTA Management",
          country: "Türkiye",
        }
      : {
          home: "Home",
          ...
          current: "OTA & Channel Management",
          serviceType: "Hotel OTA Management / OTA Channel Management",
          country: "Turkey",
        };
...
const jsonLd = buildHotelOtaManagementServiceJsonLd({
  locale,
  baseUrl,
  ...
  return (
  <>
  <JsonLd id="hotel-ota-management-service-jsonld" data={jsonLd} />
 ...
 <StepSection2New data={stepData} header={t("h3Section.header")}/>
    ...
    />
     ...
     <QuestionsSection2 variant="light" faqs={faqs} />
        <FaqPrompt
            namespace="OtaManagementPage.faqPrompt"
            faqSlug="otel-ota-sss"
          />
