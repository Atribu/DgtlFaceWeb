...
function buildSmmContentProductionServiceJsonLd({
  locale,
  baseUrl,
  pageUrl,
  servicesUrl,
  ...
  const labels =
    locale === "tr"
      ? {
          ...
          current: "İçerik Üretimi",
          serviceType: "Sosyal Medya İçerik Üretimi / Content Production",
          country: "Türkiye",
        }
      : {
          home: "Home",
          ...
          serviceType: "Social Media Content Production / Content Production",
          country: "Turkey",
        };
...
export default async function Page({ params }) {
  ...
  const t = await getTranslations({
    locale,
    namespace: "SocialMediaContent",
  });

  const t2 = await getTranslations({
    locale,
    namespace: "SocialMediaContent.h4Section",
  });
...
const jsonLd = buildSmmContentProductionServiceJsonLd({
  locale,
  baseUrl,
  ...
  return (
    <>
    <JsonLd id="smm-content-production-service-jsonld" data={jsonLd} />
 ...
 <StepSection2New data={stepData} header={t("h3Section.header")}/>
    ...
    />
     ...
     <QuestionsSection2 variant="light" faqs={faqs} />
      <FaqPrompt
                            namespace="SocialMediaContent.faqPrompt"
                           faqSlug="icerik-uretimi-sss"
                          />
