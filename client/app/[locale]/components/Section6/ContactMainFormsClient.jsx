...
const ContactMainFormsClient = () => {
  ...
  const handleMobileSubmit = async (e) => {
    ...
    `;
      ...
      if (!response.ok) {
        throw new Error("Gonderim basarisiz oldu");
      }
      ...
      setError(err.message || "Bir hata olustu, lutfen tekrar deneyin");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      ...
      >
        ...
        {success && <div className="text-green-600 text-lg">{t("success_message_sent")}</div>}
      ...
      <div className="flex lg:hidden w-[100%] py-4 px-3 bg-white items-center justify-center">
        ...
        >
          ...
          {success && <div className="text-green-600 text-sm">{t("success_message_sent")}</div>}
...
export default ContactMainFormsClient;
