  ...
  return (
    <div className="flex w-screen h-auto min-h-[100vh] md:min-h-[50vh] lg:h-[82vh] items-center justify-center bg-[#080612] pt-[15%] md:pt-0" >
      <div className='flex flex-col lg:flex-row w-[96%] lg:w-[95%] items-center justify-between lg:gap-[10px]'>
        ...
        />
        <div className='flex flex-col items-center justify-center text-center w-[95%] md:w-[80%] lg:w-[65%] gap-2 lg:gap-[16px] font-inter text-white mt-4 md:mt-10'>
            ...
            <h2 className='text-[22px] lg:text-[24px] font-semibold leading-[120%] -tracking-[0.96px] mt-2'>{header3}</h2>
             <p className='flex text-[12px] md:text-[14px] lg:text-[16px] font-normal leading-[120%] lg:leading-[130%]  lg:mb-[16px]'>{text2}</p>
        </div>
        <Image
        src={aiImg}
        alt='ai'
