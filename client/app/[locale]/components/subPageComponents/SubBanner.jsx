...
const SubBanner = ({header,header2,text,buttonLink, buttonText, header3,text2}) => {
  return (
    <div className="flex w-screen h-auto min-h-[100vh] md:min-h-[50vh] lg:mt-[16vh] items-center justify-center bg-[#080612] pt-[18%] md:pt-0" >
      <div className='flex flex-col lg:flex-row w-[96%] lg:w-[95%] items-center justify-between lg:gap-[10px]'>
        ...
        />
        <div className='flex flex-col items-center justify-center text-center lg:text-start w-[95%] md:w-[80%] lg:w-[65%] gap-2 lg:gap-[16px] font-inter text-white mt-4 md:mt-10'>
