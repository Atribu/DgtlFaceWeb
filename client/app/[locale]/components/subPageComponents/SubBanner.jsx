  ...
  return (
    <div className="flex w-screen h-auto min-h-[100vh] md:min-h-[50vh] lg:mt-[16vh] items-center justify-center bg-[#000000] pt-[18%] md:pt-[9%] lg:pt-0" >
      <div className='flex flex-col lg:flex-row w-[96%] lg:w-[95%] items-center justify-between lg:gap-[10px]'>
        ...
        width={aiImg.width}
        height={aiImg.height}
        className='w-[70%] md:w-[40%] lg:w-auto h-auto lg:min-w-[19%] lg:max-w-[220px] xl:min-w-[22%] xl:max-w-[300px]'
        />
        <div className='flex flex-col items-center justify-center text-center xl:text-start w-[95%] md:w-[88%] lg:w-[65%] gap-2 lg:gap-[16px] font-inter text-white mt-4 md:mt-10'>
      ...
      [&_li]:mb-1 [&_a]:underline"
        ...
        width={aiImg.width}
        height={aiImg.height}
        className='hidden lg:flex transform scale-x-[-1] lg:min-w-[18%] lg:max-w-[220px] xl:min-w-[22%] xl:max-w-[300px]'
        />
      </div>
    </div>
  )
