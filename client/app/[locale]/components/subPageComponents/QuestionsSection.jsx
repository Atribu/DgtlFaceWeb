...
const QuestionsSection = ({color}) => {
  ...
  return (
    <div className='flex flex-col w-full items-center justify-center gap-[70px] lg:gap-[168px] font-inter28 mt-2'>
      <div className='flex flex-col lg:w-[75%] items-center justify-center text-center gap-[24px] lg:gap-[48px]'>
        <h3 className={`text-[24px] lg:text-[30px] text-[${color}] font-bold leading-[120%] -tracking-[0.48px] lg:-tracking-[0.96px]`}> Dgtlface <span className='bg-gradient-to-r from-[#54B9CF] to-[#547DCF] bg-clip-text text-transparent'>{t("aboutpage_s3_span1")}</span></h3>
        <div className='grid grid-cols-2 lg:flex items-center justify-center gap-[24px] text-white'>
            <div className='flex bg-darkBlue  px-[20px] py-[10px] lg:px-[24px] lg:py-[24px] items-center justify-center text-center rounded-[22px] text-[16px] lg:text-[20px] font-bold leading-[150%] lg:leading-[120%] -tracking-[0.3px] lg:-tracking-[0.48px] gap-[10px] lg:gap-[22px]'>
