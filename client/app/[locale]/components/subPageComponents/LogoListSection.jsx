    ...
    <section className="flex flex-col w-screen items-center justify-center -mb-10 bg-white ">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-[42px] lg:gap-0">
        ...
        <div className="flex flex-col w-full md:w-[60%]  text-start text-darkBlue font-inter">
          <h2 className="text-[24px] font-semibold font-inter28 leading-[120%] -tracking-[0.48px]">
            {introTitle}
          </h2>
        ...
        {cards?.map((card, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center lg:justify-start lg:items-start gap-[12px] lg:gap-[18px]">
              <p className="relative text-justify justify-start text-[#140f25] lg:text-[16px] font-normal lg:leading-[120%] text-[14px] -tracking-[0.28px] leading-[130%]">
                {card.description}
              </p>
            </div>
          </div>
