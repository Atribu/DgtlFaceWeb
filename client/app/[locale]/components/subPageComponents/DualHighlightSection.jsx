  ...
  return (
    <div className="grid grid-cols-2 gap-4 w-[95%] mt-[0px]">
      {items.map((item, index) => (
        <div
          key={index}
          className="flex flex-col items-center justify-start gap-[16px] lg:w-[100%] text-center lg:text-start"
        >
          ...
          <p className="text-[12px] w-[90%] lg:w-[80%] lg:text-[14px] ml-10 font-inter28 font-normal leading-[130%] lg:leading-[140%] tracking-[-0.36px] lg:tracking-[-0.32px] text-black mt-[18px] lg:mt-0 ">
            {item.text}
          </p>
        </div>
      ))}
