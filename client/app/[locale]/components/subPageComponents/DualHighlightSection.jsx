...
const DualHighlightSection = ({ items }) => {
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 w-[95%] lg:w-[98%] xl:w-[95%] mt-[0px]">
      {items.map((item, index) => (
        <div
          key={index}
          className="flex flex-col items-center justify-start lg:gap-[16px] lg:w-[100%] text-center lg:text-start"
        >
          <button className="gradient-darktext-header relative flex border w-[90%] lg:w-[96%] xl:w-[90%] py-[16px] px-auto items-center justify-center lg:px-[1px] lg:py-[24px] text-[20px] lg:text-[24px] font-semibold leading-[120%] tracking-[-0.28px]  text-black">
