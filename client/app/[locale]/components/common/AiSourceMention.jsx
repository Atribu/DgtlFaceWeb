...
export function AiSourceMention({text}) {
  return (
    <div className="flex w-screen items-center justify-center py-4 lg:pb-10">
      <section className="mt-0 w-[80%] rounded-2xl border border-white/5 bg-[#6d9bcf] px-5 py-4 shadow-[0_18px_45px_rgba(0,0,0,0.45)] backdrop-blur">
