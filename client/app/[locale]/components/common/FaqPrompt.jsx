...
const decorativeQuestionMarks = [
  {
    id: 1,
    size: 54,
    className: "absolute left-[4%] top-[10%] rotate-[-18deg] text-white",
  },
  {
    id: 2,
    size: 42,
    className: "absolute left-[10%] bottom-[12%] rotate-[16deg] text-white",
  },
  {
    id: 3,
    size: 46,
    className: "absolute left-[22%] top-[6%] rotate-[22deg] text-white",
  },
  {
    id: 4,
    size: 38,
    className: "absolute left-[34%] bottom-[14%] rotate-[-12deg] text-white",
  },
  {
    id: 5,
    size: 44,
    className: "absolute left-[46%] top-[12%] rotate-[14deg] text-white",
  },
  {
    id: 6,
    size: 40,
    className: "absolute right-[34%] bottom-[10%] rotate-[-20deg] text-white",
  },
  {
    id: 7,
    size: 48,
    className: "absolute right-[24%] top-[8%] rotate-[12deg] text-white",
  },
  {
    id: 8,
    size: 44,
    className: "absolute right-[16%] bottom-[4%] rotate-[-24deg] text-white",
  },
  {
    id: 9,
    size: 52,
    className: "absolute right-[8%] top-[16%] rotate-[20deg] text-white",
  },
  {
    id: 10,
    size: 36,
    className: "absolute right-[3%] bottom-[28%] rotate-[-10deg] text-white",
  },
    {
    id: 11,
    size: 38,
    className: "absolute left-[1%] bottom-[56%] rotate-[16deg] text-white",
  },
    {
    id: 12,
    size: 40,
    className: "absolute right-[30%] bottom-[44%] rotate-[12deg] text-white",
  },
];
