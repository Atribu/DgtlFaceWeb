...
const Contact = () => {
  return (
    <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[570px] relative bg-[#080612]">
      {/* Arkaplan Resmi */}
      <Image 
        src={Main} 
        alt="main" 
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-10 text-center px-4 pt-12 gap-2">
        ...
        <h1 className="relative text-center">
          <span className="text-white text-4xl sm:text-[56px] font-bold font-['Inter'] capitalize leading-[1.1] sm:leading-[61.60px]">
            Contact us
          </span>{" "}
          <span 
            className="bg-gradient-to-r from-[#54b9cf] to-[#a754cf] text-transparent bg-clip-text text-4xl sm:text-[56px] font-bold font-['Inter'] capitalize leading-[1.1] sm:leading-[61.60px]">
            Now
          </span>
        </h1>
