    ...
    <div className='flex items-center justify-center bg-cover bg-center h-screen w-screen'  style={{ background:
      ...
      <div className="w-[90%] md:w-[85%] lg:w-[100%] relative flex flex-col-reverse lg:grid lg:grid-cols-2  bg-darkBlue  py-8  md:py-12 text-black lg:min-h-[680px] lg:px-0 lg:py-24 lg:bg-transparent items-center justify-center">
        ...
        <div className="flex flex-col text-start items-start justify-center h-full ">
          <h3 className=" flex flex-row  gap-2 text-[24px] leading-[120%] lg:text-5xl font-inter28 font-bold lg:leading-[57.60px] pb-1 -tracking-[0.48px]">
          ...
          <div className="flex flex-col gap-2">
            <p className="font-inter28 text-[14px] text-white font-normal leading-[130%] -tracking-[0.28px] w-[45%]">
            {text}
            </p>
            
          </div>

          <button className="mt-6 gradient-border-button w-[114px] h-[42px] justify-center font-inter leading-[16.8px] tracking-[-0.28px] text-[14px]">
            Explore
          </button>
          <style jsx>{`
